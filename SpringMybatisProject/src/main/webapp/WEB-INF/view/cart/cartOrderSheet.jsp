...
<body>
	...
	<p>
		1.주문상품<br>
	<form action="goodsPayment" method="get">
		<table width="600" border=1>
			...
			<c:forEach items="${lists }" var="dto">
				<tr>
					<td><img
						src="../goods/upload/${dto.goodsDTO.prodImage.split(',')[0] }"
						width="50" /></td>
					<td>상품명<br> ${dto.goodsDTO.prodName }&nbsp;&nbsp;&nbsp;
						${dto.cartDTO.cartQty }개/ ${dto.goodsDTO.prodPrice }원
					</td>
