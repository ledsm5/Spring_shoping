...
<input type = "hidden" name= "memId" value="${lists[0].memId }">
 <!-- command에서 데이트포멧줘서 무조건 갑을 줘야한다  -->
	<table border = 1 align="center">
		<tr>
			<td>아이디</td>
			<td>${lists.get(0).memId }</td>
		</tr>
		<tr>
			<td>이름</td>
			<td>${lists.get(0).memName }</td>
		</tr>
		<tr>
			<td>우편번호</td>
		...
		<tr>
			...
			<td>
				...
				<c:if test="${lists[0].memGender == 'Y'}"> 여자  </c:if>			
			</td>
		</tr>
		<tr>
			<td>계좌번호</td>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input type = "button" value="회원탈퇴" onclick ="javascript:location.href='../memDel?memId=${lists[0].memId}'"> <!-- .mem은 스프링에서는 안쓴다  -->
			</td>
		</tr>
	</table>
</form>
